...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">الوظائف</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#" data-toggle="modal" data-target="#addJobModal">إضافة وظيفة جديد</a>
                    </li>
                </ol>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            <div class="alert alert-info m-0">لا توجد وظائف لعرضها</div>
                                        </td>
                                    </tr>
                                    @else
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white py-2">
                <h6 class="modal-title mb-0" id="addJobModalLabel">
                    <i class="la la-plus"></i> إضافة الوظيفة
                </h6>
            ...
            <div class="modal-body p-3">
                <form id="addJobForm" method="POST" action="{{ route('jobs.store') }}">
                    ...
                    <div class="form-group mb-2">
                        <label for="name" class="small font-weight-bold">اسم الوظيفة</label>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning text-white py-2">
                <h6 class="modal-title mb-0" id="editJobModalLabel">
                    <i class="la la-edit"></i> تعديل الوظيفة
                </h6>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body p-3">
                <form id="editJobForm" method="POST">
                    ...
                    @method('PUT')
                    <div class="form-group mb-2">
                        <label for="edit_name" class="small font-weight-bold">اسم الوظيفة</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#editJobModal').on('show.bs.modal', function(event) {
            ...
            modal.find('#editJobForm').attr('action', '/admin/jobs/' + id);
        });
        ...
        function deleteJob(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const url = "{{ route('jobs.destroy', ':id') }}".replace(':id', id);
