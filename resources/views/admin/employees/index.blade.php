                                ...
                                <tbody>
                                    @foreach ($index as $employee)
                                        <tr>
                                          ...
                                          <td>
    <a href="{{ route('employees.show', $employee->employee_code) }}" class="btn btn-sm btn-primary" title="عرض التفاصيل">
        <i class="fas fa-eye"></i>
    </a>

    <a href="{{ route('employees.edit', $employee->employee_code) }}" class="btn btn-sm btn-info" title="تعديل">
        <i class="fas fa-edit"></i>
    </a>

    <button onclick="DeleteRow({{ $employee->id }})" class="btn btn-danger btn-sm" title="حذف">
