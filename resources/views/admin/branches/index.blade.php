...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">الفروع</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#" data-toggle="modal" data-target="#addBranchModal">إضافة فرع جديد</a>
                    </li>
                </ol>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            <div class="alert alert-info m-0">لا توجد فروع لعرضها</div>
                                        </td>
                                    </tr>
                                    @else
                                    @foreach ($index as $branch)
                                    <tr>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white py-2">
                <h6 class="modal-title mb-0" id="addBranchModalLabel">
                    <i class="la la-plus"></i> إضافة الفرع
                </h6>
            ...
            <div class="modal-body p-3">
                <form id="addBranchForm" method="POST" action="{{ route('branches.store') }}">
                    ...
                    <div class="form-group mb-2">
                        <label for="name" class="small font-weight-bold">اسم الفرع</label>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning text-white py-2">
                <h6 class="modal-title mb-0" id="editBranchModalLabel">
